    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-[85px] p-8">
        ...
        >
          ...
          <p className="text-gray-600 mt-2">Enhance your coding skills with our curated problems</p>
        </motion.div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-600">{problem.timeLimit}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            <motion.button
                              ...
                              onClick={() => navigate(`/problems/${problem._id || problem.id}/view`)}
                            >
                              <Eye size={18} />
                            </motion.button>
                            <motion.button
                              ...
                              onClick={() => navigate(`/problems/${problem._id || problem.id}/solve`)}
                            >
