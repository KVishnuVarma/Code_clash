          ...
          <div className="space-y-6">
            ...
            <nav className="space-y-3">
              <a href="/userDashboard/user-problems" 
                 className={`block ${colors.textSecondary} hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center space-x-2 group`}>
            ...
            <div className="space-y-4">
              ...
              <div className={`${colors.border} border rounded-lg p-4 hover:shadow-lg transition-all duration-300 hover:scale-105 bg-opacity-50 backdrop-blur-sm`}>
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    <span className="block font-semibold text-white">Vishnu Varma</span>
                ...
                <div className="flex space-x-6 justify-center">
                  <a href="https://www.linkedin.com/in/vishnu-varma-kalidindi/" 
                     ...
                     className="w-8 h-8 bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110">
                  ...
                  <a href="https://github.com/KVishnuVarma" 
                     target="_blank" 
                     rel="noopener noreferrer" 
                     className="w-8 h-8 bg-gray-800 hover:bg-gray-900 text-white flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="mailto:raghuvarmakalidindi12345@gmail.com" 
                     target="_blank" 
                     rel="noopener noreferrer" 
                     className="w-8 h-8 bg-red-600 hover:bg-red-700 text-white flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://www.instagram.com/kalidindi_vishnu_varma_219/?next=%2F" 
                     target="_blank" 
                     rel="noopener noreferrer" 
                     className="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 text-white flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`border-t ${colors.border} pt-8`}>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <a href="/privacy" 
                 className={`${colors.textSecondary} hover:text-white transition-colors text-sm hover:underline`}>
                Privacy Policy
              </a>
              <a href="/terms" 
                 className={`${colors.textSecondary} hover:text-white transition-colors text-sm hover:underline`}>
